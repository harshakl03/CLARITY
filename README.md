...
│   ├── resnet152.py             # ResNet152 baseline model
│   ├── model_variants.py        # Alternative architecture variations
│   └── pretrained_weights/      # Model checkpoints (7M & 60M params)
│
├── data/
...
│   └── metadata/
│       ├── pathologies.json     # 14 pathology definitions
│       └── train_val_split.csv  # Data split configuration
│
├── training/
│   ├── train.py                 # Main training pipeline
│   ├── loss_functions.py        # Weighted focal loss implementations
│   ├── optimizers.py            # Optimizer configurations (Adam, SGD, RMSprop)
│   ├── callbacks.py             # Early stopping, learning rate scheduling
│   └── experiments.json         # 270+ experimental configurations
│
├── xai/
│   ├── gradcam_plus_plus.py     # Grad-CAM++ attribution method
│   ├── layer_cam.py             # LayerCAM implementation
│   ├── score_cam.py             # Score-CAM gradient-free method
│   ├── saliency_maps.py         # Pixel-level gradient sensitivity
│   ├── integrated_gradients.py  # Axiomatic attribution method
│   ├── visualization.py         # Heatmap generation & rendering
│   └── xai_validator.py         # XAI correctness validation
│
├── evaluation/
│   ├── metrics.py               # Precision, Recall, F1, AUC calculations
│   ├── confusion_matrix.py      # Per-pathology performance analysis
│   ├── validation.py            # Cross-validation protocols
│   ├── statistical_tests.py     # Significance testing
│   └── clinical_validation.py   # Radiologist-aligned validation
│
├── notebooks/
│   ├── 01_EDA.ipynb            # Exploratory data analysis
│   ├── 02_Model_Training.ipynb  # Training procedures
│   ├── 03_XAI_Analysis.ipynb    # Explainability exploration
│   ├── 04_Performance_Analysis.ipynb # Results visualization
│   └── 05_Ablation_Studies.ipynb # Component contribution analysis
│
├── configs/
│   ├── training_config.yaml     # Hyperparameter configurations
│   ├── augmentation_config.yaml # Augmentation strategies
│   ├── model_config.yaml        # Model architecture specs
